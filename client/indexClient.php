    ...
    <table class="table" style="font-weight:bold; text-align:center">
        ...
        <tbody>
            ...
            while ($elemento = $consulta->fetch_object()) {
                ...
                echo "<td>$id</td>";
                echo "<td>$titulo</td>";
                echo "<td><a href='detalle.php?id=$id' class='btn btn-info btn-sm'>$descripcion</a></td>";
                echo "<td>$categoria</td>";
                echo "<td>$precio</td>";                    
                echo "<td><a href = '../public/uploads/$imagen'><img class='card-img-top' src='../public/uploads/" . $imagen . "' alt='Title' style='width:100px'></a></td>";                   
